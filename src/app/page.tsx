...
import { PublicationAccordion } from "@/components/publication-accordion";
        ...
        <div className="flex min-h-0 flex-col gap-y-3">
          ...
          {DATA.education.map((education, id) => (
            ...
            >
              ...
              />
              {/* If there is publication list dcuments and add modals with details */}
              {education.publications && education.publications.length > 0 && (
                <BlurFade delay={BLUR_FADE_DELAY * 8 + id * 0.05}>
                  <PublicationAccordion publications={education.publications} />
                </BlurFade>
              )}
            </BlurFade>
          ))}
